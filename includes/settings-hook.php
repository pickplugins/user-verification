...
?>
    ...
    <div class="section">
        ...
        $comment_form_notice = isset($user_verification_settings['isspammy']['comment_form_notice']) ? $user_verification_settings['isspammy']['comment_form_notice'] : 'no';
        ...
        $block_login = isset($user_verification_settings['isspammy']['block_login']) ? $user_verification_settings['isspammy']['block_login'] : 'no';
