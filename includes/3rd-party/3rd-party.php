...
if (is_plugin_active('wp-user-manager/wp-user-manager.php')) {
    require_once(user_verification_plugin_dir . 'includes/3rd-party/wp-user-manager/functions.php');
    require_once(user_verification_plugin_dir . 'includes/3rd-party/wp-user-manager/settings-hook.php');
}

if (is_plugin_active('nextend-facebook-connect/nextend-facebook-connect.php')) {
    require_once(user_verification_plugin_dir . 'includes/3rd-party/nextend-facebook-connect/functions.php');
}
