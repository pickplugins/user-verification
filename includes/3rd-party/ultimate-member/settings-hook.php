...
function user_verification_settings_content_ultimate_member(){
    ...
    ?>
    <div class="section">
        <div class="section-title"><?php echo __('Ultimate Member', 'user-verification'); ?></div>
        <p class="description section-description"><?php echo __('Customize options for Ultimate Member.', 'user-verification'); ?></p>
